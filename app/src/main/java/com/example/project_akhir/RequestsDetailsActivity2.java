...
public class RequestsDetailsActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new FirebaseDatabaseHelper2().updateBook(key, requests, new
                        FirebaseDatabaseHelper2.DataStatus(){
                            @Override
                            public void dataIsLoad(List<Requests> requests, List<String> keys) {
                            }
                            @Override
                            public void dataIsUpdate() {
                                Toast.makeText(RequestsDetailsActivity2.this,"Data Update",Toast.LENGTH_LONG).show();
                            }
                            @Override
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(RequestsDetailsActivity2.this,"Data Delete",Toast.LENGTH_LONG).show();
                new FirebaseDatabaseHelper2().deleteBook(key, new
                        FirebaseDatabaseHelper2.DataStatus() {
                            @Override
                            public void dataIsLoad(List<Requests> requests, List<String> keys) {
                            }
