...
public class expert extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInAccount acct = GoogleSignIn.getLastSignedInAccount(expert.this);
        if (acct != null) {
        ...
        mGoogleSignInClient.signOut()
                .addOnCompleteListener(this, new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(expert.this,"Successfully signed out",Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(expert.this, MainActivity.class));
                        finish();
                    }
                });
    }
