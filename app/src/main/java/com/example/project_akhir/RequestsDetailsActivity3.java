...
public class RequestsDetailsActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new FirebaseDatabaseHelper3().updateBook(key, requests, new
                        FirebaseDatabaseHelper3.DataStatus(){
                            @Override
                            public void dataIsLoad(List<Requests> requests, List<String> keys) {
                            }
                            @Override
                            public void dataIsUpdate() {
                                Toast.makeText(RequestsDetailsActivity3.this,"Data Update",Toast.LENGTH_LONG).show();
                            }
                            @Override
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(RequestsDetailsActivity3.this,"Data Delete",Toast.LENGTH_LONG).show();
                new FirebaseDatabaseHelper3().deleteBook(key, new
                        FirebaseDatabaseHelper3.DataStatus() {
                            @Override
                            public void dataIsLoad(List<Requests> requests, List<String> keys) {
                            }
