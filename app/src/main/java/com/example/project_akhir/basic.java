...
public class basic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Childbtn = (Button) findViewById(R.id.child);
        ...
        GoogleSignInAccount acct = GoogleSignIn.getLastSignedInAccount(basic.this);
        if (acct != null) {
            ...
            fn.setText(persongivenname);
            ln.setText(personFamilyName);
            ...
            mGoogleSignInClient.signOut()
                    .addOnCompleteListener(this, new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            Toast.makeText(basic.this,"Successfully signed out",Toast.LENGTH_SHORT).show();
