...
public class display1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Side = (Button) findViewById(R.id.kelas);
        ...
        new FirebaseDatabaseHelper1().readRequests(new FirebaseDatabaseHelper1.DataStatus() {
            @Override
            public void dataIsLoad(List<Requests> requests, List<String> keys) {
                new
                        RecyclerView_Config().setConfig(mrecyclerView,display1.this,requests,keys);
            }
            @Override
