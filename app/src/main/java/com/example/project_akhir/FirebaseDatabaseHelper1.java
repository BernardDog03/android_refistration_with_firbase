...
public class FirebaseDatabaseHelper1 {
    ...
    public FirebaseDatabaseHelper1() {
        ...
        mReferenceRequests = mDatabase.getReference("greeting");
    }
    ...
    public void updateBook1(String key, Requests req, final DataStatus dataStatus) {
    ...
    public void deleteBook1(String key, final DataStatus dataStatus) {
